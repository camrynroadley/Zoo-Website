...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  Animal ID to delete: <input type="number" name="animalIDDelete">
  <span class="error"> <?php echo $animalIDDeleteErr;?></span>
  <br><br>
...
//put your query here
$query1 = 'DELETE FROM Animal WHERE Animal_ID=\''.$animalIDDelete."'";
